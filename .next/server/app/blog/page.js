...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2503)), "C:\\projects\\nextjs-beginners\\app\\blog\\page.tsx"],
          
        }]
      },
        {
          'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7379)), "C:\\projects\\nextjs-beginners\\app\\blog\\error.tsx"],
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2323)), "C:\\projects\\nextjs-beginners\\app\\blog\\loading.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6557)), "C:\\projects\\nextjs-beginners\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2162));
...
/* harmony import */ var zustand_shallow__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2876);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4005);
/* __next_internal_client_entry_do_not_use__ Posts auto */ 




const Posts = ()=>{
    const [posts, loading, getAllPosts] = (0,_store__WEBPACK_IMPORTED_MODULE_3__/* .usePosts */ .k)((state)=>[
            state.posts,
            state.loading,
            state.getAllPosts
        ], zustand_shallow__WEBPACK_IMPORTED_MODULE_4__/* .shallow */ .X);
    react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(()=>{
        getAllPosts();
    }, []);
    return loading ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h3", {
        children: "Loading..."
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4005);
...
const Search = ()=>{
    ...
    const getPostsBySearch = (0,_store__WEBPACK_IMPORTED_MODULE_2__/* .usePosts */ .k)((state)=>state.getPostsBySearch);
...
;// CONCATENATED MODULE: ./utils/api/hooks/getPosts.ts
...
const usePosts = (0,esm/* create */.Ue)((set)=>({
        posts: [],
        loading: false,
        getAllPosts: async ()=>{
            set({
...
const e0 = proxy["Posts"];

;// CONCATENATED MODULE: ./components/Search.tsx

const Search_proxy = (0,module_proxy.createProxy)(String.raw`C:\projects\nextjs-beginners\components\Search.tsx`)

// Accessing the __esModule property and exporting $$typeof are required here.
// The __esModule getter forces the proxy target to create the default export
// and the $$typeof value is for rendering logic to determine if the module
// is a client boundary.
const { __esModule: Search_esModule, $$typeof: Search_$$typeof } = Search_proxy;
const Search_default_ = Search_proxy.default;

const Search_e0 = Search_proxy["Search"];
...
async function Blog() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(Search_e0, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [405,914,55,628,609], () => (__webpack_exec__(1532)));
