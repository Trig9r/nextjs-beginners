(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/ssr/[next]_entry_app-renderer_tsx_6409f9._.js", {
...
;
"TURBOPACK { chunking-type: isolatedParallel }";
import __TURBOPACK__layout__$23$2__, { chunks as __TURBOPACK__chunks__of__layout__$23$2__ } from "COMPONENT_2";
;
const LOADER_TREE = [
    "",
    {
        "children": [
                ...
                "children": [
                    ...
                    {},
                    {
                        "page": [
                            ...
                            JSON.stringify(__TURBOPACK__chunks__of__page__$23$0__) + '.js'
                        ]
                    }
                ]
            },
            {
                "loading": [
                    ...
                    JSON.stringify(__TURBOPACK__chunks__of__loading__$23$1__) + '.js'
                ]
            }
        ]
    },
    {
        "layout": [
            ...
            JSON.stringify(__TURBOPACK__chunks__of__layout__$23$2__) + '.js'
        ],
        metadata: {
            icon: [
                async (props)=>[
                        {
                            url: __TURBOPACK__icon__$23$3__.src,
...
async function runOperation(renderData) {
    ...
    const req = {
        ...
        headers: initProxiedHeaders(headersFromEntries(renderData.rawHeaders), renderData.data?.serverInfo)
    };
    ...
    const result = await renderToHTMLOrFlight(req, res, renderData.path, query, renderOpt);
...
//# sourceMappingURL=[next]_entry_app-renderer_tsx_6409f9._.js.map